...
namespace Medibook.Controllers
{
    ...
    public class FileManagerController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            model.strUrlFull =Request.QueryString["Url"] + "";
            model.strBackId = Request.QueryString["BackId"] + "";
            ...
            //setup current link
            model.strCurrLink = "/FileManager/Index?type=" + model.strType + "&editor=" + model.strEditor + "&lang=" + model.strLang + "&profile=" + model.strProfile + "&BackId=" + model.strBackId + "&Url=" + model.strUrlFull;
            ...
            switch (model.strCmd)
            {
                ...
                default:    //just a regular page load
                    if (model.strCurrPath != "")
                    {
                        ...
                        model.objFItem.strThumbImage = "/Content/filemanager/images/ico/folder_return.png";
                    ...
                    foreach (string strF in model.arrFolders)
                    {
                        ...
                        model.objFItem.strThumbImage = "/Content/filemanager/images/ico/folder.png";
                    ...
                    foreach (string strF in model.arrFiles)
                    {
                        ...
                        if ((model.boolOnlyImage && model.objFItem.boolIsImage) || (model.boolOnlyVideo && model.objFItem.boolIsVideo) || (!model.boolOnlyImage && !model.boolOnlyVideo))
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    model.objFItem.strThumbImage = "/Content/filemmanager/images/ico/" + Path.GetExtension(strF).TrimStart('.').ToUpper() + ".png";
                                }
                                else
                                {
                                    model.objFItem.strThumbImage = "/Content/filemanager/images/ico/Default.png";
                                }
                            }
